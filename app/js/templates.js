...
this["hbs"]["main"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"row wrapper\">\n  <div class=\"row\">\n    <div class=\"small-12 small-centered columns rulesandupload\">\n\n      <div class=\"instructions\">\n        <header id=\"howToPlay\">How to play</header>\n\n        <p id=\"para3\">How to play instruction.</p>\n      </div> \n\n      <div class=\"addpost\">\n        <header id=\"addPost\">Add Post</header>\n\n        <form id=\"addPost\">\n          <input type=\"text\" placeholder=\"Photo URL\" id=\"photoURL\">\n          <input type=\"text\" placeholder=\"Answer\" id=\"answer\">\n          <button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\">Submit\n          <i class=\"mdi-content-send right\"></i></button>\n        </form> \n      </div> \n    </div>\n  </div>\n</div>\n\n<div class=\"dropdown\">\n  <label>Sort by:\n    <form id=\"sortBy\">\n      <a href=\"<input type=\"radio\" name=\"sortByOption\" class=\"sortby\" value=\"playable\" checked=\"checked\">Playable</input>\n      <input type=\"radio\" name=\"sortByOption\" class=\"sortby\" value=\"unplayable\">Unplayable</input>\n      <input type=\"radio\" name=\"sortByOption\" class=\"sortby\" value=\"myPostsAll\">My Posts - All</input>\n      <input type=\"radio\" name=\"sortByOption\" class=\"sortby\" value=\"myPostsSolved\">My Posts - Solved</input>\n      <input type=\"radio\" name=\"sortByOption\" class=\"sortby\" value=\"myPostsNot\">My Posts - Not Solved</input>\n      <button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\">Submit\n      <i class=\"mdi-content-send right\"></i></button>\n    </form>\n  </label>\n</div>\n\n  <div class=\"columns\">\n\n    <ul class=\"small-block-grid-3 posts\">\n"
